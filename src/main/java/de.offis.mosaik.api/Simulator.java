 ...
 * it will be used by {@link SimProcess#startSimulation(String[], Simulator)}.
 *
...
public abstract class Simulator {
     ...
     * @throws Exception
     */
    public abstract Map<String, Object> init(String sid, Float timeResolution, Map<String, Object>
     ...
     * @throws Exception
     */
    public abstract long step(long time, Map<String, Object> inputs, long maxAdvance)
            throws Exception;
