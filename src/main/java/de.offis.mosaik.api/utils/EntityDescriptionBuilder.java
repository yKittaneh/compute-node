...
public class EntityDescriptionBuilder {
	...
	private static final HashMap<String, HashMap<String, Integer>> globalCounts
		= new HashMap<>();

	private final LinkedList <EntityDescription> entities = new LinkedList<>();
	private final String eidPrefix;
	...
	public EntityDescription addEntityDescription(String eid, String type, 
		...
		HashMap<String, Integer> modelCounts = globalCounts
				.get(this.eidPrefix);
		int countInt = modelCounts.computeIfAbsent(type, k -> 0);
